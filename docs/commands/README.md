# OAuth and Workload Command Reference

Use the [scenario guides](../README.md) first. These pages are precise API references
for callers who already know which credential and flow they need.
